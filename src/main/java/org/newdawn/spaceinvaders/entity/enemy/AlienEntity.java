...
public class AlienEntity extends EnemyEntity {
	...
	public AlienEntity(Game game,int x,int y) {
		super("sprites/Miniboss_red_1.png",x,y);
		
		// setup the animatin frames
		frames[0] = sprite;
		frames[1] = SpriteStore.get().getSprite("sprites/Miniboss_red_2.png");
		frames[2] = sprite;
		frames[3] = SpriteStore.get().getSprite("sprites/Miniboss_red_3.png");
    ...
    public AlienEntity(Game game,String ref,int x,int y) {
        ...
        if ("sprites/Miniboss_red_1.png".equals(ref)) {
            frames[0] = sprite;
            frames[1] = SpriteStore.get().getSprite("sprites/Miniboss_red_2.png");
            frames[2] = sprite;
            frames[3] = SpriteStore.get().getSprite("sprites/Miniboss_red_3.png");
